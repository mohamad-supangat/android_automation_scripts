...
from autoclick.helpers import device, tap, random_sleep, locateCenterOnImage, screenshot
...
def search_like_button():
    return locateCenterOnImage(imgs.get('like_button'), screenshot(), confidence=0.8)
